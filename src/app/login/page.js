    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0B0E14]">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#1a1a1a] via-[#0B0E14] to-[#000000]"></div>
                <div className="absolute -top-[20%] -right-[10%] w-[600px] h-[600px] rounded-full bg-[#E10600] opacity-[0.05] blur-[120px]"></div>
                <div className="absolute -bottom-[20%] -left-[10%] w-[600px] h-[600px] rounded-full bg-[#E10600] opacity-[0.05] blur-[120px]"></div>
            ...
            <div className="relative z-10 w-full max-w-md px-4 animate-fade-in">
                ...
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
                    <h1 className="text-2xl font-bold text-white mb-2 text-center font-display">Welcome Back</h1>
                    <p className="text-gray-400 text-center mb-8 text-sm">Sign in to access premium F1 data</p>
                ...
                <p className="mt-8 text-center text-gray-500 text-sm">
                    ...
                    <Link href="/signup" className="text-[#E10600] font-semibold hover:text-[#FFD93D] transition-colors">
                        Create one now
                    </Link>
                </p>
            </div>
